...
def plot_loss(train_loss, val_loss, epochs, save_path,val_accurate_values):
    ...
    plt.legend()
    plt.savefig(os.path.join(save_path, 'loss_curve_origin_new.png'))
    plt.show()
    plt.figure()
    ...
    plt.legend()
    plt.savefig(os.path.join(save_path, 'accuracy_origin_new.png'))
    plt.show()
...
def main():
    ...
    best_acc = 0.0
    save_path = './model_origin_new/MobileNetV3_Small.pth'
