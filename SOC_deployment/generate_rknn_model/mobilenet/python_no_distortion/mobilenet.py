...
# OUT_RKNN_PATH = MODEL_DIR + 'MobileNetV2.rknn'
...
if __name__ == '__main__':
    ...
    if args.npu_device_test or args.target in RKNPU1_TARGET:
        ...
        ret = rknn.init_runtime(target=args.target,eval_mem=True)
        print('1')
        ...
        # ret = rknn.init_runtime(target='RV1103',device_id='df74f7884c2fcc27')
