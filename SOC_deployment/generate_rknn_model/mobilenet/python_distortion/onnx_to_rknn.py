...
# MODEL_PATH = MODEL_DIR + './MobileNetV3_Small_5.5_4.4_distortion.onnx'

MODEL_PATH = MODEL_DIR + './MobileNetV3_Small_distortion.onnx'



# OUT_RKNN_PATH = MODEL_DIR + './MobileNetV3_Small_5.5_4.4_distortion.rknn'

OUT_RKNN_PATH = MODEL_DIR + './MobileNetV3_Small_distortion.rknn'
...
if __name__ == '__main__':
    ...
    rknn.config(mean_values=[[255*0.485, 255*0.456, 255*0.406]], std_values=[[
                255*0.229, 255*0.224, 255*0.225]], target_platform=args.target, quantized_algorithm="mmse")
