...
![image-20240821163039548](报告.assets/image-20240821163039548.png)

<img src="报告.assets/image-20240821155516028.png" alt="image-20240821155516028" style="zoom:67%;" />
...
![image-20240821163323812](报告.assets/image-20240821163323812.png)

调整模型与训练参数在rknn模型下板端推理三次结果：![image-20240821173821247](/home/yh/.config/Typora/typora-user-images/image-20240821173821247.png)

推理三次对第二三次的惩罚加大阈值为0.8：![image-20240821182424702](/home/yh/.config/Typora/typora-user-images/image-20240821182424702.png)

阈值0.85：![image-20240821182644915](/home/yh/.config/Typora/typora-user-images/image-20240821182644915.png)

阈值0.75：![image-20240821182831436](/home/yh/.config/Typora/typora-user-images/image-20240821182831436.png)





调整模型预训练参数在rknn模型下板端推理一次结果：![image-20240821174602869](/home/yh/.config/Typora/typora-user-images/image-20240821174602869.png)



使用normal算法转换模型，不使用mmse，三次：![image-20240821175228918](/home/yh/.config/Typora/typora-user-images/image-20240821175228918.png)



使用normal算法转换模型，不使用mmse，一次：![image-20240821175322423](/home/yh/.config/Typora/typora-user-images/image-20240821175322423.png)

##### 未调整模型预训练参数的结果

![image-20240821155805103](报告.assets/image-20240821155805103.png)

![image-20240821162807709](报告.assets/image-20240821162807709.png)

<img src="报告.assets/image-20240821155819111.png" alt="image-20240821155819111" style="zoom: 67%;" />
...
![image-20240821163210251](报告.assets/image-20240821163210251.png)

未调整模型预训练参数在rknn模型下板端推理三次结果：![image-20240821174005970](/home/yh/.config/Typora/typora-user-images/image-20240821174005970.png)

未调整模型预训练参数在rknn模型下板端推理一次结果：![image-20240821174449808](/home/yh/.config/Typora/typora-user-images/image-20240821174449808.png)



使用normal算法转换模型，不使用mmse，三次：![image-20240821175608001](/home/yh/.config/Typora/typora-user-images/image-20240821175608001.png)



使用normal算法转换模型，不使用mmse，一次：![image-20240821175424298](/home/yh/.config/Typora/typora-user-images/image-20240821175424298.png)
